...
export function WeatherDisplay({ data, className }: WeatherDisplayProps) {
  ...
  return (
    <Card className={`overflow-hidden bg-card/80 backdrop-blur-md relative ${className || ""}`}>
      <div className="p-4 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold">{data.location}</h3>
            <p className="text-muted-foreground text-sm capitalize">{data.condition}</p>
          </div>
          <img 
            src={data.icon} 
            alt={data.condition} 
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">{data.temperature} {tempUnit}</span>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">{data.windSpeed} {windUnit}</span>
          </div>
          <div className="flex items-center gap-2">
