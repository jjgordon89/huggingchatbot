...
export default function Profile() {
  ...
  const [showLogin, setShowLogin] = useState(true); // State to toggle between login/register
  const [showEditProfile, setShowEditProfile] = useState(false); // State to toggle between view/edit profile
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList className="grid grid-cols-7 w-full max-w-4xl mb-8">
          ...
          <TabsTrigger value="vector-db" className="flex items-center gap-2 overflow-hidden">
            <BrainCircuit className="h-4 w-4" /> {/* Using BrainCircuit temporarily, replace with appropriate icon if available */}
 ...
 {user ? (
            <div className="space-y-6"> {/* Added a div to maintain space-y-6 */}
              {showEditProfile ? (
 ...
 <><Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        ...
                        <Button variant="outline" size="sm" onClick={() => setShowEditProfile(true)} className="mt-4">Edit Profile</Button>
                        ...
                        )} {/* End of conditional rendering for Account Information Card */}
                        <Button variant="outline" onClick={logout} className="w-fit mt-6">Logout</Button>
                      </div> // End of div for space-y-6
                    // End of div for space-y-6
                    </>
                    ) : (
                  ...
                  </TabsContent><TabsContent value="workspace" className="space-y-6">
                      {activeWorkspace ? (
                    ...
                    </TabsContent><TabsContent value="keys" className="space-y-6">
                      <Card>
                        <CardHeader>
                    ...
                    </TabsContent><TabsContent value="vector-db" className="space-y-6">
                      <Card>
                        <CardHeader>
                    ...
                    </TabsContent><TabsContent value="search" className="space-y-6">
                      
                    </TabsContent><TabsContent value="models" className="space-y-6">
                      <Card>
                        <CardHeader>
                    ...
                    </TabsContent><TabsContent value="shortcuts" className="space-y-6">
                      <Card>
                        <CardHeader>
